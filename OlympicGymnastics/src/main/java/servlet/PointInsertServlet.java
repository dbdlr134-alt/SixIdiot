// servlet/PointInsertServlet.java
package servlet;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (skillLevelStr == null) {
                ...
                response.sendRedirect("point_insert.jsp"); // 간단히 폼으로 리다이렉트
                return;
            }
            ...
            Arrays.sort(scores); // 점수를 정렬
            
            // 총점: 가장 높은 점수(scores[3]) 제외한 합계 
            ...
            dto.setTotal(total);
            dto.setAve(final_ave); // 계산된 최종 평균
